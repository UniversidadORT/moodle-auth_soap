...
/**
 * Strings for component 'auth_soap', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   auth_soap
...
$string['auth_soap_result_value_key'] = 'Webservice result value that corresponds to successful login';
